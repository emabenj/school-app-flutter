...
class BLoaders {
        ...
        content: Container(
            ...
            decoration: BoxDecoration(
                ...
                color: BHelperFunctions.isDarkMode(Get.context!)
                    ? BColors.darkerGrey.withOpacity(.9)
                    : BColors.grey.withOpacity(.9)),
            child: Center(
                child: Text(message,
  ...
  static successSnackBar({required title, message = '', duration = 3}) {
    Get.snackbar(
      ...
      icon: const Icon(Icons.check, color: BColors.white),
    );
  }
  ...
  static warningSnackBar({required title, message = ''}) {
    Get.snackbar(
      ...
      icon: const Icon(Icons.warning_outlined, color: BColors.white),
    );
  }
